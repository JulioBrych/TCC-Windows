...
public class Painel : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        textos[0][1] = "Os anfíbios Temnospondilos possuíam duas fileiras de dentes nas maxilas.";
        textos[1][0] = "Esse nunca Aparece";
        textos[1][1] = "Coletado em 2003, na Serra da Santa, em Otacílio Costa (SC), por alunos da disciplina de Ciências Biológicas, na disciplina de Paleontologia, coordenados pelo Prof. Juarês J. Aumond.\nAnfíbio Temnospondilo de rosto curto, similar a uma espécie conhecida na Rússia.O <i>Melosaurus</i>.";
